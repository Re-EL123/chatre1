...
(function () {
  ...
  function initByokUi() {
    var byokPlaceholders = {
      ...
      ollama: "Paste Ollama Cloud API key",
      kilo: "Paste Kilo Code key (optional for free)",
      cloudflare: "Paste accountId:apiToken (Workers AI)",
      llm7: "Paste LLM7 token (or unused)",
      ovhcloud: "Paste OVHcloud key (optional for free)",
      mistral: "Paste Mistral API key",
      huggingface: "Paste Hugging Face token (hf_…)",
      dashscope: "Paste DashScope / Model Studio key",
